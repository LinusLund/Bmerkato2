...
namespace Bmerkato2._0.Migrations
{
    ...
    [Migration("20230526123409_db_final_form")]
    partial class db_final_form
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Bmerkato2.Models.Entities.AddressEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Bmerkato2.Models.Entities.ContactFormEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("ContactFormsSubmitted");
                });
            ...
            modelBuilder.Entity("Bmerkato2.Models.Entities.UserAddressEntity", b =>
                {
                    ...
                    b.HasOne("Bmerkato2.Models.Identity.AppUser", "User")
                        .WithMany("Addresses")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Bmerkato2.Models.Identity.AppUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
